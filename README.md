...
- **Add prompt before transcript** — when on, the editable prompt is placed at the top of the clipboard (followed by a blank line, then the transcript). Default: on.
